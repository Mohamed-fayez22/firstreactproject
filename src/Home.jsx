...
function Home() {
  ...
  useEffect(() => {
    ...
    const sendEmail = (e) => {
      ...
      e.preventDefault();
      emailjs.sendForm('service_m7tfg9n', 'template_q058jwo', form.current, 'JpaurC0c7Ns0nKDt3')
        .then((result) => {
        ...
        <Container>
          ...
          <Row className="align-items-center">
            <Col md={6} sm={12} className="wow slideInLeft" data-wow-duration="2s" data-wow-delay="0.1s">
              <div>
                <p><span>Email:</span> mf243369@gmail.com</p>
                <p><span>Phone:</span> 01157201406</p>
                <p><span>Address:</span> Qina</p>
              </div>
            </Col>
